...
#elif defined EMPL_TARGET_ATMEGA328P
#include <avr/pgmspace.h>
#include "MPU6050System.h"

#define i2c_write   MPU6050System_twiWrite
#define i2c_read    MPU6050System_twiRead
#define delay_ms    MPU6050System_delayMs
#define get_ms      MPU6050System_getMs
#define log_i       MPU6050System_logI
#define log_e       MPU6050System_logE
#define min         fmin
#else
...
#if !defined EMPL_TARGET_STM32F4 && !defined EMPL_TARGET_ATMEGA328P
    if (int_param)
...
#define LOAD_CHUNK  (16)
    ...
    for (ii = 0; ii < length; ii += this_write) {
        this_write = min(LOAD_CHUNK, length - ii);
        ...
        #if defined EMPL_TARGET_ATMEGA328P
            int j;
            ...
            for(j=0; j<this_write; j++)
                firmware_chunk[j] = pgm_read_byte(pFirmware + j);
